...
namespace Checkpoints
{
    ...
    // BudMax: synchronized checkpoint (centrally broadcasted)
    ...
    // BudMax: get last synchronized checkpoint
    ...
    // BudMax: only descendant of current sync-checkpoint is allowed
    ...
    // BudMax: reset synchronized checkpoint to last hardened checkpoint
...
// BudMax: sync-checkpoint master key
...
// BudMax: verify signature of sync-checkpoint message
...
// BudMax: process synchronized checkpoint
